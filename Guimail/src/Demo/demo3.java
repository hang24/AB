...
public class demo3 extends JFrame implements ActionListener{
	...
	private JButton btnSend, btnCancel,btnXoaRong, btnKiemtra;
	...
	private void UIChonDangNhap() {
	    ...
	    txtSubject.setBounds(300, 50, 400, 25);
		...
		pSouth.add(btnKiemtra= new JButton("Xem nội dung email ở thời điểm hiện tại"));
